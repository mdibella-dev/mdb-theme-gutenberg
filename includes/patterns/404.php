...
<figure class="wp-block-image size-full is-style-transparent marco-404 no-margin-top"><img src="' . get_stylesheet_directory_uri() . '/assets/build/img/marco-404.png"/></figure>
<!-- /wp:image -->
</section>
<!-- /wp:group -->'
);
