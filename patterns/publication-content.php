...
?>
    <!-- wp:heading {"className":"is-style-alternate","fontSize":"large","style":{"spacing":{"top":"var:preset|spacing|50","bottom":"-0.6rem"}}} -->
    <h2 class="wp-block-heading has-large-font-size is-style-alternate" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:-0.6rem;"><?php echo _n( 'Author', 'Authors', count( $authors ) , 'mdb-theme-fse' ); ?></h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph -->
...
?>
    <!-- wp:heading {"className":"is-style-alternate","fontSize":"large","style":{"spacing":{"top":"var:preset|spacing|50","bottom":"-0.6rem"}}} -->
    <h2 class="wp-block-heading has-large-font-size is-style-alternate" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:-0.6rem;"><?php echo __( 'Publication Year', 'mdb-theme-fse' ); ?></h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph -->
    <p><?php echo $year; ?></p>
    <!-- /wp:paragraph -->
...
if ( ! is_wp_error( $terms ) and ! empty( $terms ) ) {
    ...
    ?>
    <!-- wp:heading {"className":"is-style-alternate","fontSize":"large","style":{"spacing":{"top":"var:preset|spacing|50","bottom":"-0.6rem"}}} -->
    <h2 class="wp-block-heading has-large-font-size is-style-alternate" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:-0.6rem;"><?php echo __( 'Keywords', 'mdb-theme-fse' ); ?></h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph -->
...
?>
<!-- wp:heading {"className":"is-style-alternate","fontSize":"large","style":{"spacing":{"top":"var:preset|spacing|50","bottom":"-0.6rem"}}} -->
<h2 class="wp-block-heading has-large-font-size is-style-alternate" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:-0.6rem;"><?php echo __( 'Suggested Citation', 'mdb-theme-fse' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
if ( have_rows( 'ref_sources' ) ) {
    ...
    ?>
        <!-- wp:heading {"className":"is-style-alternate","fontSize":"large","style":{"spacing":{"top":"var:preset|spacing|50","bottom":"-0.6rem"}}} -->
        <h2 class="wp-block-heading has-large-font-size is-style-alternate" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:-0.6rem;"><?php echo __( 'Sources', 'mdb-theme-fse' ); ?></h2>
        <!-- /wp:heading -->
...
if ( have_rows( 'ref_cites') ) {
    ...
    ?>
        <!-- wp:heading {"className":"is-style-alternate","fontSize":"large","style":{"spacing":{"top":"var:preset|spacing|50","bottom":"-0.6rem"}}} -->
        <h2 class="wp-block-heading has-large-font-size is-style-alternate" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:-0.6rem;"><?php echo __( 'Cited by', 'mdb-theme-fse' ); ?></h2>
        <!-- /wp:heading -->
        <!-- wp:list {"ordered":true} -->
        <ol class="wp-block-list">
            <?php
