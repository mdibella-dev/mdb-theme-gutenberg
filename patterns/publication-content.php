...
<!-- /wp:paragraph -->
<!-- wp:post-title {"level":1,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}},"typography":{"fontSize":"3.5rem"}}} /-->
<?php
...
?>
    ...
    <h2 class="wp-block-heading has-large-font-size"><?php echo _n( 'Author', 'Authors', count( $authors ) , 'mdb-theme-fse' ); ?></h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph -->
...
?>
    <!-- wp:heading {"fontSize":"large"} -->
    <h2 class="wp-block-heading has-large-font-size"><?php echo __( 'Publication Year', 'mdb-theme-fse' ); ?></h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph -->
    <p><?php echo $year; ?></p>
    <!-- /wp:paragraph -->
...
if ( ! is_wp_error( $terms ) and ! empty( $terms ) ) {
    ...
    ?>
    <!-- wp:heading {"fontSize":"large"} -->
    <h2 class="wp-block-heading has-large-font-size"><?php echo __( 'Keywords', 'mdb-theme-fse' ); ?></h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph -->
...
?>
<!-- wp:heading {"fontSize":"large"} -->
<h2 class="wp-block-heading has-large-font-size"><?php echo __( 'Suggested Citation', 'mdb-theme-fse' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
if ( have_rows( 'ref_sources') ) {
    ...
    ?>
        <!-- wp:heading {"fontSize":"large"} -->
        <h2 class="wp-block-heading has-large-font-size"><?php echo __( 'Sources', 'mdb-theme-fse' ); ?></h2>
        <!-- /wp:heading -->
...
if ( have_rows( 'ref_cites') ) {
    ...
    ?>
        <!-- wp:heading {"fontSize":"large"} -->
        <h2 class="wp-block-heading has-large-font-size"><?php echo __( 'Cited by', 'mdb-theme-fse' ); ?></h2>
        <!-- /wp:heading -->
        <!-- wp:list {"ordered":true} -->
        <ol class="wp-block-list">
            <?php
