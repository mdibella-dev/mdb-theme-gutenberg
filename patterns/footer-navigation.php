...
<div class="wp-block-group site-component-footer has-global-padding is-layout-constrained" style="margin-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--40)">
    ...
    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"14px","fontWeight":"500","textTransform":"uppercase"}}} -->
    <p class="has-text-align-center" style="font-size:14px;font-weight:500;text-transform:uppercase"><a href="/impressum"><?php echo __( 'Imprint', 'mdb-theme-fse' ); ?></a></p>
    <!-- /wp:paragraph -->
