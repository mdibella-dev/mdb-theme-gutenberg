...
<div class="wp-block-group alignfull">
    ...
    <div class="wp-block-group alignwide">
        <!-- wp:site-title {"level":0,"style":{"typography":{"fontSize":"16px","fontWeight":"500","textTransform":"uppercase"}}} /-->

        <!-- wp:group {"className":"wp-group","layout":{"type":"flex","flexWrap":"nowrap"}} -->
        <div class="wp-block-group wp-group">
            <!-- wp:navigation {"ref":8802,"overlayMenu":"never","className":"primary-desktop-navigation","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal","flexWrap":"nowrap"},"style":{"typography":{"fontSize":"14px","fontWeight":"500","textTransform":"uppercase"},"spacing":{"blockGap":"1.75rem"}}} /-->
