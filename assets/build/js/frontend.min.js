...
function doSlideout( open_or_close ) {
    ...
    const icon = document.querySelector( '.is-navbar-hamburger span' );
    ...
    if ( open_or_close == false ) {
        ...
        icon.classList.remove( 'svg-symbol-hamburger-cross' );
        icon.classList.add( 'svg-symbol-hamburger' );
        ...
        icon.classList.remove( 'svg-symbol-hamburger' )
        icon.classList.add( 'svg-symbol-hamburger-cross' );
    }
}
